...
export default function News({ news }) {
    ...
    return (<>
        ...
        <div className={utilStyles.topContainerNews}>
            <h3 style={{fontSize:39, fontWeight:400, width:550, marginTop: 100}}>Robotically Fabricated Structure (RFS) Nominated for the LOOP Design Awards 2022 People's Choice</h3>
