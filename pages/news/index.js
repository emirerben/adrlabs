                            ...
                            <div className={utilStyles.newsBlock}>
                                ...
                                />
                                 ...
                                 <h1>Robotically Fabricated Structure (RFS) Receives Global Future Design Award</h1>
                                            <Link style={{marginBottom: 0}} href={'/news/globaldesignaward'}>
                                                READ MORE
                                            </Link>
                                </div>
                            </div>
                            <div className={utilStyles.newsBlock}>
                                <p style={{marginTop: 0}}>10/05/22</p>
                                <Image className={utilStyles.researchImages}
                                ...
                                />
                                 ...
                                 <h1>RFS Awarded the Honorable Mention for the Loop Design Awards 2022</h1>
                                            <Link style={{marginBottom: 0}} href={'/news/loopdesignawards'}>
                                                READ MORE
                                            </Link>
                                </div>
                            </div>
                            <div className={utilStyles.newsBlock}>
                                <p style={{marginTop: 0}}>08/29/22</p>
                                <Image className={utilStyles.researchImages}
                                ...
                                />
                                 ...
                                 <h1>RFS Nominated for the LOOP Design Awards 2022 People's Choice</h1>
                                            <Link style={{marginBottom: 0}} href={'/news/peopleschoice'}>
                                                READ MORE
                                            </Link>
                                </div>
                            </div>
                            <div className={utilStyles.newsBlock}>
                                <p style={{marginTop: 0}}>08/11/22</p>
                                <Image className={utilStyles.researchImages}
                                ...
                                />
                                 ...
                                 <h1>Robotically Fabricated Structure (RFS) Longlisted for Dezeen Awards 2022</h1>
                                            <Link style={{marginBottom: 0}} href={'/news/dezeenawards'}>
                                                READ MORE
                                            </Link>
                                </div>
                            </div>
                            <div className={utilStyles.newsBlock}>
                                <p style={{marginTop: 0}}>08/10/22</p>
                                <Image className={utilStyles.researchImages}
                                ...
                                />
                                 ...
                                 <h1>Adel Announced as Juror for ACSA 2022 Timber Competition</h1>
                                            <Link style={{marginBottom: 0}} href={'/news/acsa'}>
                                                READ MORE
                                            </Link>
                                </div>
                            </div>
                            <div className={utilStyles.newsBlock}>
                                <p style={{marginTop: 0}}>03/30/22</p>
                                <Image className={utilStyles.researchImages}
                                ...
                                />
                                 ...
                                 <h1>On Air Exhibition</h1>
                                            <Link style={{marginBottom: 0}} href={'/news/onairexhibition'}>
                                                READ MORE
                                            </Link>
                                </div>
                            </div>
                        ...
                        <div className={utilStyles.sameyearPublicationsContainer}>
                            <div className={utilStyles.newsBlock}>
                                ...
                                <h1>Research Paper Presentation at the ACADIA Conference</h1>
                                            <Link style={{marginBottom: 0}} href={'/news/acadiaconference'}>
                                                READ MORE
                                            </Link>
                                </div>
                            </div>
                            <div className={utilStyles.newsBlock}>
                                <p style={{marginTop: 0}}>10/20/21</p>
                                <Image className={utilStyles.researchImages}
                                ...
                                <h1>Timber Pavilion Opening at the Matthaei Botanical Gardens</h1>
                                            <Link style={{marginBottom: 0}} href={'/news/timberpavilionopening'}>
                                                READ MORE
                                            </Link>
                                </div>
                            </div>
                            <div className={utilStyles.newsBlock}>
                                <p style={{marginTop: 0}}>08/31/21</p>
                                <Image className={utilStyles.researchImages}
                                ...
                                <h1>$1.58M NSF Grant to Explore Human–Robot Collaborative Construction</h1>
                                            <Link style={{marginBottom: 0}} href={'/news/nsfgrant'}>
                                                READ MORE
                                            </Link>
                                </div>
                            </div>
                            <div className={utilStyles.newsBlock}>
                                <p style={{marginTop: 0}}>03/31/21</p>
                                <Image className={utilStyles.researchImages}
                                ...
                                <h1>Keynote Lecture International Manufacturing Forum Series 2021</h1>
                                            <Link style={{marginBottom: 0}} href={'/news/internationalmanufacturing'}>
                                                READ MORE
                                            </Link>
                                </div>
                            </div>
