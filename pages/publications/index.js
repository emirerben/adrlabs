                ...
                <div className={utilStyles.OneNews}>
                    ...
                    <div className={utilStyles.BlockWithoutBreaker}>
                        ...
                        <div className={utilStyles.PublicationsTitlePart}>
                            ...
                            <p>Technology | Architecture + Design, vol. 5, no. 1, pp. 38-43, 2021</p>
                    ...
                    <div className={utilStyles.BlockWithoutBreaker}>
                        ...
                        <div className={utilStyles.PublicationsTitlePart}>
                            ...
                            <p>Realignments: Toward Critical Computation: Proceedings Catalog of the 41st Annual Conference of the Association for Computer Aided Design in Architecture (ACADIA), 2021</p>
                ...
                <div className={utilStyles.OneNews}>
                    ...
                    <div className={utilStyles.BlockWithoutBreaker}>
                        ...
                        <div className={utilStyles.PublicationsTitlePart}>
                            ...
                            <p>Ph.D. Thesis, ETH, Zurich, 2020</p>
                    ...
                    <div className={utilStyles.BlockWithoutBreaker}>
                        ...
                        <div className={utilStyles.PublicationsTitlePart}>
                            ...
                            <p>Distributed Proximities: Proceedings Catalog of the 40th Annual Conference of the Association for Computer Aided Design in Architecture (ACADIA), 2020</p>
                            <div className={utilStyles.linksPublications}>
                ...
                <div className={utilStyles.OneNews}>
                    ...
                    <div className={utilStyles.BlockWithoutBreaker}>
                        ...
                        <div className={utilStyles.PublicationsTitlePart}>
                            ...
                            <p>Recalibration: On Imprecision and Infidelity: Proceedings Catalog of the 38th Annual Conference of the Association for Computer Aided Design in Architecture (ACADIA), Mexico City, 2018</p>
                            <div className={utilStyles.linksPublications}>
