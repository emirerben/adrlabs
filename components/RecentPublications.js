        ...
        <div className={utilStyles.TopicContainerStyle}>
            ...
            <div className={utilStyles.moreinfoStyle} style={{display:showMe2?"flex":"none"}}>
                    <Image className={utilStyles.researchImageStyle}
                        ...
                        height={334}
                    />
                    <p>Several research projects have investigated the use of automated assembly technologies (e.g., industrial robotic arms) for the fabrication of nonstandard timber structures. Building on these projects, we present a novel and transferable process for the robotic fabrication of bespoke timber subassemblies made of off-the-shelf standard timber elements. A nonstandard timber structure,  consisting of four bespoke subas semblies: three vertical supports and a Zollinger roof structure, acts as the case study for the research and validates the feasibility of the proposed process. <br></br> <br></br> <a target="_blank" rel="noopener noreferrer" style={{color: 'white'}}href='https://drive.google.com/file/d/1Q4hzXtLFFQp-vT_kAObbLKv1_cykyM-9/view'>PDF</a></p>
            </div>
            <div className={utilStyles.breakerWhite}></div>
            <div className={utilStyles.TopicBlockStyle}>
